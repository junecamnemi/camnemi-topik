...
window.QUIZ = [
  ...
  { band: 2, q: "「내일 한국에 가요?」 — How do you say 'I will go to Korea tomorrow'?",
    ...
    ], correct: 0, explain: "Future = verb stem + ㄹ 거예요: 갈 거예요." },
  { band: 2, q: "「Please don't smoke here」 = ?",
    ...
    ], correct: 0, explain: "Negative command = V-지 마세요." },
  ...
  { band: 3, q: "「If you have time, let's meet」 = ?",
    ...
    ], correct: 0, explain: "Conditional = V-(으)면." },
  { band: 3, q: "「I have been to Korea before」 = ?",
    ...
    ], correct: 0, explain: "Experience = V-아/어 보다 + ㄴ 적이 있다." },
  ...
  { band: 4, q: "「He said he is a student」 = ?",
    options: [
      ...
      { t: "학생인데요.", gl: "context" },
      { t: "학생이니까요.", gl: "reason" }
    ], correct: 0, explain: "Reported speech for nouns = N(이)라고 하다." },
  { band: 4, q: "「I'm afraid it will rain」 = ?",
    options: [
      { t: "비가 올까 봐요.", gl: "ㄹ까 봐 = worried that" },
      { t: "비가 와서요.", gl: "because" },
      { t: "비가 오면요.", gl: "if" }
    ], correct: 0, explain: "Concern = V-(으)ㄹ까 봐." },
