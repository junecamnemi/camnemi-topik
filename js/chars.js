/* Camnemi TOPIK — character collection (60 cute webtoon idols: 30 female + 30 male)
   Face-focused portraits, generated for the app. Select via the avatar on Home. */
window.CHAR_LIST = [
  // ---- Female (30) ----
  { id: 'f-01', g: 'f', name: 'Aran', img: 'assets/img/chars/f-01.webp', face: 'assets/img/chars/face/f-01.webp' },
  { id: 'f-02', g: 'f', name: 'Chaea', img: 'assets/img/chars/f-02.webp', face: 'assets/img/chars/face/f-02.webp' },
  { id: 'f-03', g: 'f', name: 'Dahee', img: 'assets/img/chars/f-03.webp', face: 'assets/img/chars/face/f-03.webp' },
  { id: 'f-04', g: 'f', name: 'Roy', img: 'assets/img/chars/f-04.webp', face: 'assets/img/chars/face/f-04.webp' },
  { id: 'f-05', g: 'f', name: 'Yuna', img: 'assets/img/chars/f-05.webp', face: 'assets/img/chars/face/f-05.webp' },
  { id: 'f-06', g: 'f', name: 'Sua', img: 'assets/img/chars/f-06.webp', face: 'assets/img/chars/face/f-06.webp' },
  { id: 'f-07', g: 'f', name: 'Jian', img: 'assets/img/chars/f-07.webp', face: 'assets/img/chars/face/f-07.webp' },
  { id: 'f-08', g: 'f', name: 'Daeun', img: 'assets/img/chars/f-08.webp', face: 'assets/img/chars/face/f-08.webp' },
  { id: 'f-09', g: 'f', name: 'Yerin', img: 'assets/img/chars/f-09.webp', face: 'assets/img/chars/face/f-09.webp' },
  { id: 'f-10', g: 'f', name: 'Somi', img: 'assets/img/chars/f-10.webp', face: 'assets/img/chars/face/f-10.webp' },
  { id: 'f-11', g: 'f', name: 'Chaewon', img: 'assets/img/chars/f-11.webp', face: 'assets/img/chars/face/f-11.webp' },
  { id: 'f-12', g: 'f', name: 'Arin', img: 'assets/img/chars/f-12.webp', face: 'assets/img/chars/face/f-12.webp' },
  { id: 'f-13', g: 'f', name: 'Nayeon', img: 'assets/img/chars/f-13.webp', face: 'assets/img/chars/face/f-13.webp' },
  { id: 'f-14', g: 'f', name: 'Eunseo', img: 'assets/img/chars/f-14.webp', face: 'assets/img/chars/face/f-14.webp' },
  { id: 'f-15', g: 'f', name: 'Rua', img: 'assets/img/chars/f-15.webp', face: 'assets/img/chars/face/f-15.webp' },
  { id: 'f-16', g: 'f', name: 'Sieun', img: 'assets/img/chars/f-16.webp', face: 'assets/img/chars/face/f-16.webp' },
  { id: 'f-17', g: 'f', name: 'Juha', img: 'assets/img/chars/f-17.webp', face: 'assets/img/chars/face/f-17.webp' },
  { id: 'f-18', g: 'f', name: 'Miso', img: 'assets/img/chars/f-18.webp', face: 'assets/img/chars/face/f-18.webp' },
  { id: 'f-19', g: 'f', name: 'Harin', img: 'assets/img/chars/f-19.webp', face: 'assets/img/chars/face/f-19.webp' },
  { id: 'f-20', g: 'f', name: 'Dahye', img: 'assets/img/chars/f-20.webp', face: 'assets/img/chars/face/f-20.webp' },
  { id: 'f-21', g: 'f', name: 'Sea', img: 'assets/img/chars/f-21.webp', face: 'assets/img/chars/face/f-21.webp' },
  { id: 'f-22', g: 'f', name: 'Roa', img: 'assets/img/chars/f-22.webp', face: 'assets/img/chars/face/f-22.webp' },
  { id: 'f-23', g: 'f', name: 'Iseo', img: 'assets/img/chars/f-23.webp', face: 'assets/img/chars/face/f-23.webp' },
  { id: 'f-24', g: 'f', name: 'Haein', img: 'assets/img/chars/f-24.webp', face: 'assets/img/chars/face/f-24.webp' },
  { id: 'f-25', g: 'f', name: 'Gaeun', img: 'assets/img/chars/f-25.webp', face: 'assets/img/chars/face/f-25.webp' },
  { id: 'f-26', g: 'f', name: 'Rina', img: 'assets/img/chars/f-26.webp', face: 'assets/img/chars/face/f-26.webp' },
  { id: 'f-27', g: 'f', name: 'Bora', img: 'assets/img/chars/f-27.webp', face: 'assets/img/chars/face/f-27.webp' },
  { id: 'f-28', g: 'f', name: 'Jiyul', img: 'assets/img/chars/f-28.webp', face: 'assets/img/chars/face/f-28.webp' },
  { id: 'f-29', g: 'f', name: 'Hani', img: 'assets/img/chars/f-29.webp', face: 'assets/img/chars/face/f-29.webp' },
  { id: 'f-30', g: 'f', name: 'Narin', img: 'assets/img/chars/f-30.webp', face: 'assets/img/chars/face/f-30.webp' },
  // ---- Male (30) ----
  { id: 'm-01', g: 'm', name: 'Jihoon', img: 'assets/img/chars/m-01.webp', face: 'assets/img/chars/face/m-01.webp' },
  { id: 'm-02', g: 'm', name: 'Minjun', img: 'assets/img/chars/m-02.webp', face: 'assets/img/chars/face/m-02.webp' },
  { id: 'm-03', g: 'm', name: 'Seojun', img: 'assets/img/chars/m-03.webp', face: 'assets/img/chars/face/m-03.webp' },
  { id: 'm-04', g: 'm', name: 'Dohyun', img: 'assets/img/chars/m-04.webp', face: 'assets/img/chars/face/m-04.webp' },
  { id: 'm-05', g: 'm', name: 'Hajun', img: 'assets/img/chars/m-05.webp', face: 'assets/img/chars/face/m-05.webp' },
  { id: 'm-06', g: 'm', name: 'Siwoo', img: 'assets/img/chars/m-06.webp', face: 'assets/img/chars/face/m-06.webp' },
  { id: 'm-07', g: 'm', name: 'Yejun', img: 'assets/img/chars/m-07.webp', face: 'assets/img/chars/face/m-07.webp' },
  { id: 'm-08', g: 'm', name: 'Gunwoo', img: 'assets/img/chars/m-08.webp', face: 'assets/img/chars/face/m-08.webp' },
  { id: 'm-09', g: 'm', name: 'Hyunwoo', img: 'assets/img/chars/m-09.webp', face: 'assets/img/chars/face/m-09.webp' },
  { id: 'm-10', g: 'm', name: 'Juwon', img: 'assets/img/chars/m-10.webp', face: 'assets/img/chars/face/m-10.webp' },
  { id: 'm-11', g: 'm', name: 'Seonwoo', img: 'assets/img/chars/m-11.webp', face: 'assets/img/chars/face/m-11.webp' },
  { id: 'm-12', g: 'm', name: 'Taeyun', img: 'assets/img/chars/m-12.webp', face: 'assets/img/chars/face/m-12.webp' },
  { id: 'm-13', g: 'm', name: 'Eunwoo', img: 'assets/img/chars/m-13.webp', face: 'assets/img/chars/face/m-13.webp' },
  { id: 'm-14', g: 'm', name: 'Jiho', img: 'assets/img/chars/m-14.webp', face: 'assets/img/chars/face/m-14.webp' },
  { id: 'm-15', g: 'm', name: 'Rowoon', img: 'assets/img/chars/m-15.webp', face: 'assets/img/chars/face/m-15.webp' },
  { id: 'm-16', g: 'm', name: 'Sungmin', img: 'assets/img/chars/m-16.webp', face: 'assets/img/chars/face/m-16.webp' },
  { id: 'm-17', g: 'm', name: 'Woojin', img: 'assets/img/chars/m-17.webp', face: 'assets/img/chars/face/m-17.webp' },
  { id: 'm-18', g: 'm', name: 'Junho', img: 'assets/img/chars/m-18.webp', face: 'assets/img/chars/face/m-18.webp' },
  { id: 'm-19', g: 'm', name: 'Kangmin', img: 'assets/img/chars/m-19.webp', face: 'assets/img/chars/face/m-19.webp' },
  { id: 'm-20', g: 'm', name: 'Ian', img: 'assets/img/chars/m-20.webp', face: 'assets/img/chars/face/m-20.webp' },
  { id: 'm-21', g: 'm', name: 'Yunho', img: 'assets/img/chars/m-21.webp', face: 'assets/img/chars/face/m-21.webp' },
  { id: 'm-22', g: 'm', name: 'Jaehyun', img: 'assets/img/chars/m-22.webp', face: 'assets/img/chars/face/m-22.webp' },
  { id: 'm-23', g: 'm', name: 'Donghyuk', img: 'assets/img/chars/m-23.webp', face: 'assets/img/chars/face/m-23.webp' },
  { id: 'm-24', g: 'm', name: 'Siyun', img: 'assets/img/chars/m-24.webp', face: 'assets/img/chars/face/m-24.webp' },
  { id: 'm-25', g: 'm', name: 'Minjae', img: 'assets/img/chars/m-25.webp', face: 'assets/img/chars/face/m-25.webp' },
  { id: 'm-26', g: 'm', name: 'Taemin', img: 'assets/img/chars/m-26.webp', face: 'assets/img/chars/face/m-26.webp' },
  { id: 'm-27', g: 'm', name: 'Seoho', img: 'assets/img/chars/m-27.webp', face: 'assets/img/chars/face/m-27.webp' },
  { id: 'm-28', g: 'm', name: 'Jungwoo', img: 'assets/img/chars/m-28.webp', face: 'assets/img/chars/face/m-28.webp' },
  { id: 'm-29', g: 'm', name: 'Hangyeol', img: 'assets/img/chars/m-29.webp', face: 'assets/img/chars/face/m-29.webp' },
  { id: 'm-30', g: 'm', name: 'Luka', img: 'assets/img/chars/m-30.webp', face: 'assets/img/chars/face/m-30.webp' }
];
...
/* face-crop thumbnail (small circle) vs full body img */
function charFace(c) { return (c && c.face) ? c.face : (c ? c.img : ''); }
...
function openCharPicker() {
  _charTab = myChar().g || 'f';
  const ov = $id('char-picker-overlay');
...
function setCharTab(g) {
  ...
  ov.querySelectorAll('.ctab').forEach(b => b.classList.toggle('on', b.dataset.g === g));
}
...
function nameRowHTML() {
  return `
    <div class="cp-name-row">
      <span class="cp-name"><img src="${charFace(myChar())}" alt="" class="cp-name-face"> ${esc(myCharName())}</span>
